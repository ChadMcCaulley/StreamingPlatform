...
/**
 * Demo catalog using open-source Blender Foundation films.
 * Streams are local test footage under /public/videos (Google sample bucket is 403).
 */
export const catalog: Content[] = [
  {
    ...
    trailerUrl: '/videos/big-buck-bunny.mp4',
    videoUrl: '/videos/big-buck-bunny.mp4',
    accentFrom: '#2d6a4f',
    accentTo: '#95d5b2',
    featured: true,
    trending: true,
  ...
  },
  {
    ...
    trailerUrl: '/videos/sintel.mp4',
    videoUrl: '/videos/sintel.mp4',
    accentFrom: '#6a040f',
    accentTo: '#e85d04',
    featured: true,
    trending: true,
  ...
  },
  {
    ...
    trailerUrl: '/videos/sintel-trailer.mp4',
  ...
  },
  {
    ...
    trailerUrl: '/videos/jellyfish.mp4',
    videoUrl: '/videos/jellyfish.mp4',
    accentFrom: '#9b2226',
    accentTo: '#ee9b00',
    newRelease: true,
